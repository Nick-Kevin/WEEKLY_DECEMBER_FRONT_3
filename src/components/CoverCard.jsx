...
function CoverCard (props) {
    return (
        ...
        >
            ...
            <img src={props.vector} className="w-40 lg:w-auto" alt="vector" />
            <h2 className="w-full text-start pointer pewter-blue-text text-xl lg:text-4xl f-bold tracking-tighter">{props.title}</h2>
        </div>
    )
}
