...
function App() {
  ...
  const thirdRowInAbout = () => {
    ...
    const secondRow = () => {
      return (
        <h3 className="text-2xl lg:text-4xl !leading-tight f-bold">
    ...
    const thirdRow = () => {
      return (
        <div className="relative mt-6 flex flex-col lg:flex-row items-center gap-x-2 lg:mt-14">
          ...
          <img
            src={vectorInAbout}
            className="absolute opacity-75 lg:opacity-100 bottom-10 lg:bottom-6 w-14 lg:w-auto left-[-50px] lg:left-[-400px]"
            alt="vector"
          />
        </div>
      );
  ...
  return (
    <>
      <div className="relative">
        ...
        <img
          src={curlVector}
          className="absolute z-20 bottom-[-75px] left-[47%] lg:bottom-[-205px] lg:left-[49%] w-4 lg:w-auto"
          alt="vector"
        />
      </div>
      <div className="bg-white py-10 lg:py-28 relative">
        ...
        <img
          src={curlVector}
          className="absolute z-20 bottom-[-30px] left-[47%] lg:bottom-[-80px] lg:left-[49%] w-4 lg:w-auto"
          alt="vector"
        />
      </div>
      ...
      <div className="bg-white py-16 lg:py-40 relative">
        <img
          src={starInPricing}
          className="absolute opacity-0 lg:opacity-100 z-0 top-80 right-10"
          alt="star"
        />
        <SectionHeader
        ...
        <img
          src={vectorInPricing}
          className="absolute z-0 bottom-28 left-16"
          alt="star"
        />
        <img
          src={curlVector}
